 ...
 * 
 * Custom page template for homepage with enhanced layout including
 * hero section, category highlights, newsletter signup, and latest posts.
 * This template will appear in Page Attributes dropdown in WordPress admin.
 *
					...
					if ($hero_query->have_posts()) :
						...
						<div class="hero-fallback">
							<div class="hero-fallback-content">
								<h1 class="hero-fallback-title">Welcome to <?php bloginfo('name'); ?></h1>
								<p class="hero-fallback-description"><?php bloginfo('description'); ?></p>
								<a href="<?php echo esc_url(home_url('/blog')); ?>" class="hero-fallback-button">
									Explore Our Content
								</a>
							</div>
						</div>
		...
		<section class="homepage-categories">
			...
			if ($main_categories) :
				...
				<div class="categories-fallback">
					...
					<p>We're setting up our content categories. Check back soon for organized content sections!</p>
				</div>
			<?php endif; ?>
		</section>
		...
		<section class="homepage-latest">
			...
			<div class="latest-posts-grid">
				...
				if ($latest_posts->have_posts()) :
					...
					?>
					<div class="latest-posts-fallback">
						<p>No posts available yet. Please add some content to see the latest stories.</p>
					</div>
				<?php endif; ?>
			</div>
		</section>

		<!-- Custom Page Content (if any) -->
		<?php if (have_posts()) : ?>
			<?php while (have_posts()) : the_post(); ?>
				<?php if (get_the_content()) : ?>
					<section class="homepage-custom-content">
